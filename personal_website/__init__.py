...
import personal_website.controllers.home_controller as home
import personal_website.controllers.pubs_controller as pubs
import personal_website.controllers.blog_controller as blog
...
def init_routing(config):
    ...
    add_controller_routes(config, pubs.PublicationsController, 'publications')
